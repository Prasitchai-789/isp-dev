...
//         columns: [
//             {
//                 data: workOrders.id, // ใช้คอลัมน์นี้ในการเรียงข้อมูล
//                 visible: false // ซ่อนคอลัมน์นี้จากการแสดงผลในตาราง
//             },
//             // {
...
//                     return `
//                         <a href="#" wire:click="confirmEdit(${row.id})" data-bs-toggle="modal" data-bs-target="#WorkOrderModal" class="btn btn-link text-warning">
//                             <i class="bi bi-pencil-square" style="font-size: 18px;"></i>
//                         </a>
//                         <a href="#" wire:click="confirmDelete(${row.id})"  class="btn btn-link text-danger">
...
//             }
//         ],
//         order: [[0, 'desc']], // คอลัมน์วันที่ (index 6) เรียงลำดับจากล่าสุดไปหาล่าสุด
//         columnDefs: [
