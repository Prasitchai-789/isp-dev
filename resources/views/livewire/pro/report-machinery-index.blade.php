                    ...
                    <div class="row align-items-center">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12 font_anuphan">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('report-machinery.index', ['machineryId' => $machinery->id]) }}"><i
                            ...
                            <div class="table-responsive font_anuphan my-2">
                                                ...
                                                <td class="text-center">
                                                    @if ($spareparts->isNotEmpty())
                                                        @php
                                                            ...
                                                            $daysDifference = $plan_startDate->diffInDays(
                                                                $plan_endDate,
                                                            );
                                                            if ($daysDifference < 1) {
                                                                $status = 3;
                                                        ...
                                                        @endphp
                                                        @if ($status == 1)
                                                            <span class="badge bg-success"><i class="bi bi-check2-circle">@if ($sparepart->plan_spare)
                                                                {{ \Carbon\Carbon::parse($sparepart->plan_spare)->translatedFormat('j F Y') }}
                                                            @else
                                                                ไม่ระบุวันที่
                                                            @endif</i></span>
                                                        @elseif ($status == 2)
                                                            <span class="badge bg-warning"><i class="bi bi-exclamation-circle">@if ($sparepart->plan_spare)
                                                                {{ \Carbon\Carbon::parse($sparepart->plan_spare)->translatedFormat('j F Y') }}
                                                            @else
                                                                ไม่ระบุวันที่
                                                            @endif</i></span>
                                                        @elseif ($status == 3)
                                                            <span class="badge bg-danger"><i class="bi bi-x-circle">@if ($sparepart->plan_spare)
                                                                {{ \Carbon\Carbon::parse($sparepart->plan_spare)->translatedFormat('j F Y') }}
                                                            @else
                                                                ไม่ระบุวันที่
                                                            @endif</i></span>
                                ...
                                <!-- ADD MODAL -->
                                <div wire:ignore.self class="modal fade" id="sparepartModal"
                                    data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                    aria-labelledby="sparepartModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div
                                                class="modal-header {{ $edit ? 'bg-c-yellow' : 'bg-c-blue' }} text-white">
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="row" id="error">
                                                            ...
                                                            <div class="col-md-12 col-12  mb-2">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <textarea type="text" class="form-control form-control-sm" id="remark_spare" name="remark_spare"
                                                                        wire:model="remark_spare" placeholder="" required></textarea>
                                                                </div>
                                                                @error('remark_spare')
                                                                    <span class="error">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="d-flex justify-content-end gap-2 font_Prompt">
                                                            <button wire:loading.attr='disabled'
                                                                wire:target='photo_spare' type="submit"
