                                    ...
                                    <table class="table table-hover" id="pc-dt-simple">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('report-machinery.index',['id' =>$machinery->id ])}}" class="avtar avtar-xs btn-link-secondary">
                                                        <i class="bi bi-eye text-primary" style="font-size: 18px;"></i>
                                                    </a>
                                                    <a href="#" wire:click='confirmEdit({{ $machinery->id }})' data-bs-toggle="modal"
                                                        data-bs-target="#machineryModal" class="avtar avtar-xs btn-link-secondary">
                                                    ...
                                                    <div class="row" id="error">
                                                        ...
                                                        <div class="mb-3 font_Prompt"> *
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                @error('photo_machinery.*') <span class="error">{{
                                                                    $message
                                                                    }}</span> @enderror
